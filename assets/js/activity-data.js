  ...
  situations: [
    {
      ...
      biasLayers: {
        ...
        model: "Le modèle surinterprète le rôle et injecte un profil masculin, prestige-compatible, à partir de régularités issues de ses données d'entraînement.",
    ...
    },
    {
      ...
      biasLayers: {
        ...
        model: "Le modèle densifie la scène avec des marqueurs récurrents associés aux métiers STEM dans ses corpus : homme, jeunesse, équipement, isolement fonctionnel.",
    ...
    },
    {
      ...
      biasLayers: {
        ...
        model: "Le modèle ajoute une féminisation, une appartenance ethnique au personnage, ainsi qu'une dramaturgie de la bienveillance qui n'était pas demandée, en activant des stéréotypes de soin et d'empathie.",
  ...
  conclusionSections: [
    {
      ...
      items: [
        "Un prompt peut être relativement neutre tout en restant situé : la neutralité ne veut pas dire absence totale de cadrage.",
